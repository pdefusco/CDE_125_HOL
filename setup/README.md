...
```
#AWS
% ./setup/new_deploy_hol.sh pauldefusco 10 s3a://pdf-jan-26-buk-7c0e831f/data/cde-hol bank
```

```
#Azure
% ./setup/new_deploy_hol.sh pauldefusco 7 abfs://logs@go01demoazure.dfs.core.windows.net/data/cde-hol manufacturing
```
